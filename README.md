...
Installation
--------------------------------------------------------------------------------
To compile and run, first ensure that you have the necessary build tools and the SDL2 library installed (`apt install build-essential cmake libglu1-mesa-dev libsdl2-dev` on Debian systems).
