...
namespace calc {
    ...
    struct ScalarDiv {
        static void div(const T* dat1, const T dat2, T* out, std::size_t size)
        {
     ...
     */
    template <>
    struct ScalarDiv<float, 2> {
        static void div(const float* dat1,
                        const float dat2,
                        float* out,
                        std::size_t)
        {
